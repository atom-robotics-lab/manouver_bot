...
class DifferentialDriver :
    ...
    def gpio_setup(self) :
        ...
        self.GPIO.setup(self.leftA , GPIO.OUT)
        self.GPIO.setup(self.leftB , GPIO.OUT)
        self.GPIO.setup(self.rightA , GPIO.OUT)
        self.GPIO.setup(self.rightB , GPIO.OUT)
    ...
    def params_setup(self) :
        ...
        self.wheel_separation = rospy.get_param("mr_robot_firmware/wheel_separation")
